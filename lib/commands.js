...
export default (globals) => {
	...
	return commands = [{
...

		{
			...
			handler: async ({ user, private: priv }, { guild }, { error, reply }) => {
...

		{
			...
			handler: async ({ user, amount }, { guild, member: author }, { GuildData, reply }) => {
			...
			handler: async ({ user, reason }, { guild, member: author }, { GuildData }) => {
				if (!GuildData.Moderation) GuildData.Moderation = {};
				const { Moderation } = GuildData;
			...
			handler: async ({ user, reason }, { guild, member: author }, { GuildData, reply }) => {
				if (!GuildData.Moderation) GuildData.Moderation = {};
				const { Moderation } = GuildData;
			...
			handler: async ({ user, reason, duration }, { guild, member: author }, { GuildData, reply }) => {
				if (!GuildData.Moderation) GuildData.Moderation = {};
				const { Moderation } = GuildData;

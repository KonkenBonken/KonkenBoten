...
let commands;
let client, Duration, CleanDate, moment, ParseModLogs, WriteDataBase, ObjectMerge, MutedPermissions, DataBase, capital, newDiv, encodeT, SuggestRespond;
export default (globals) => {
	...
	return commands = [{
			...
			handler: async ({ suggestion }, { member }, { error, GuildData: { Suggestions: Rule }, reply }) => {

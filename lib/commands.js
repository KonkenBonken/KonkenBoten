...
export async function afterMod({ com, Moderation, guild, author, user, reason, banMessage, dmInvite, ObjectMerge, duration }) {
...
export const commands = ({ client, Duration, CleanDate, capital, moment, ParseModLogs, WriteDataBase, ObjectMerge, MutedPermissions, DataBase /*,Cache*/ }) => [{
...

	{
		...
		handler: async ({ user, reason }, { reply, guild, member: author }, { GuildData }) => {
			...
			afterMod({ com: 'warn', Moderation, guild, author, user, reason, ObjectMerge });
		...
		handler: async ({ user, reason }, { reply, guild, member: author }, { GuildData }) => {
			...
			afterMod({ com: 'kick', Moderation, guild, author, user, reason, dmInvite: true, ObjectMerge });
		...
		handler: async ({ user, reason, duration }, { reply, guild, member: author }, { GuildData }) => {
			...
			afterMod({ com: duration ? 'tempban' : 'ban', Moderation, guild, author, user, reason, dmInvite: !!duration, ObjectMerge, duration });
		...
		handler: async ({ user, reason }, { reply, guild, member: author }, { GuildData }) => {
			...
			afterMod({ com: 'unban', Moderation, guild, author, user, reason, dmInvite: true, ObjectMerge });
		...
		handler: async ({ user, reason, duration }, { reply, guild, member: author }, { GuildData }) => {
			...
			afterMod({ com: duration ? 'tempmute' : 'mute', Moderation, guild, author, user, reason, ObjectMerge, duration });
			reply({ content: `${member.displayName} has been warned`, ephemeral: true });
		}
	}, {
		com: 'unmute',
		...
		handler: async ({ user, reason }, { reply, guild, member: author }, { GuildData }) => {
			...
			afterMod({ com: 'unmute', Moderation, guild, author, user, reason, ObjectMerge });
			reply({ content: `${member.displayName} has been warned`, ephemeral: true });
		}
	}
];
